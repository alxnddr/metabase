...
(defn- convert-param-mapping-val [new-id v]
  (-> v
      (update ::mb.viz/param-mapping-source (partial convert-param-ref new-id))
      (update ::mb.viz/param-mapping-target (partial convert-param-ref new-id))
      (assoc ::mb.viz/param-mapping-id (or new-id (::mb.viz/param-mapping-id v)))))
